...
const Page = async () => {
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-gray-100/70">
      <div className="w-full max-w-lg h-auto flex flex-col gap-4 lg:gap-6 bg-white rounded-2xl shadow-lg shadow-gray-100 p-4 lg:p-6">
